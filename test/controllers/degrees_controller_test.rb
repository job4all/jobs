...
class DegreesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create degree" do
    assert_difference('Degree.count') do
      post degrees_url, params: { degree: { name: @degree.name, tdegree_id: @degree.tdegree_id } }
    end
  ...
  test "should update degree" do
    patch degree_url(@degree), params: { degree: { name: @degree.name, tdegree_id: @degree.tdegree_id } }
