...
class InstitutesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create institute" do
    assert_difference('Institute.count') do
      post institutes_url, params: { institute: { city_id: @institute.city_id, name: @institute.name } }
    end
  ...
  test "should update institute" do
    patch institute_url(@institute), params: { institute: { city_id: @institute.city_id, name: @institute.name } }
