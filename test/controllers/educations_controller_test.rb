...
class EducationsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create education" do
    assert_difference('Education.count') do
      post educations_url, params: { education: { city_id: @education.city_id, degree_id: @education.degree_id, division: @education.division, institute_id: @education.institute_id, omarks: @education.omarks, passyear: @education.passyear, persent: @education.persent, subject: @education.subject, tdegree_id: @education.tdegree_id, tmarks: @education.tmarks, user_id: @education.user_id } }
    end
